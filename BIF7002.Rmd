...
```{r SRL, fig.show="hold", fig.cap=("De gauche à droite: Structure 2D de la séquence inférée à l'aide des ensembles RELIABLE, rna3dmotif_jan2025 et ALL, respectivement."), echo=FALSE, out.width='33%', fig.show='hold', fig.align='center', out.height=250}
...
```{r 6var1, fig.show="hold", echo=FALSE, out.width='75%', fig.show='hold', fig.align='center', out.height=400}
knitr::include_graphics("6VAR_rel.svg")

``` 
```{r 6var2, fig.show="hold", echo=FALSE, out.width='75%', fig.show='hold', fig.align='center', out.height=400}
knitr::include_graphics("6VAR_atlas.svg")

``` 
```{r 6var3, fig.show="hold", fig.cap=("De haut en bas: Structure 2D de la séquence inférée à l'aide des ensembles RELIABLE, rna3dmotif_jan2025 et ALL, respectivement."), echo=FALSE, out.width='75%', fig.show='hold', fig.align='center', out.height=400}
...
```{r ribo1, fig.show="hold", echo=FALSE, out.width='100%', fig.show='hold', fig.align='center', out.height=300}
knitr::include_graphics("2HOJ_rel.svg")

```
```{r ribo2, fig.show="hold",echo=FALSE, out.width='100%', fig.show='hold', fig.align='center', out.height=425}
knitr::include_graphics("2HOJ_atlas.svg")

```
```{r ribo3, fig.show="hold", fig.cap=c("De haut en bas: Structure 2D de la séquence inférée à l'aide des ensembles RELIABLE, rna3dmotif_jan2025 et ALL, respectivement."), echo=FALSE, out.width='100%', fig.show='hold', fig.align='center', out.height=250}
