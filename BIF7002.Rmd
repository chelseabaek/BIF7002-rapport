...
```{r module-example, fig.align="center", fig.show="hold", fig.cap="(gauche) Le module d'ARN, RIN-2 [@RIN-17]; (droite) Le ribosome 1VQM tirée du PDB [@1VQM]", echo=FALSE, out.width='30%'}
knitr::include_graphics("RIN-2.png")
knitr::include_graphics("1VQM.png")
```

```{r module-example2, fig.align="center", fig.cap="Les occurrences du RIN-2 (A-Minor Type I) [@RIN-17]", echo=FALSE, out.width='70%'}
...
La Figure \@ref(fig:rna-3E5C) (gauche) représente une visualisation de la structure secondaire. Les parenthèses correspondent aux bases appariées (vert) et les points correspondent aux régions non appariées telles que les *multiloops* (rouge), les boucles internes (jaune) et les *hairpin loops* (bleu).
...
```{r Leontis-Westhof-table, fig.align="center", fig.show="hold", fig.cap="La notation Leontis-Westhof", echo=FALSE, out.width='75%'}
knitr::include_graphics("Leontis-Westhof.png")
```

Dans la Figure \@ref(fig:RIN-17), par exemple, si l'on considère les noeuds 4 et 6, on observe que l'arête reliant ces deux noeuds est TSS, ce qui indique que les orientation des liaison est 
trans, l'arête en interaction est Sugar/Sugar et orientation des brins est paralèlle.
...
## Jeux de données
SECIS Element (1WSU)
GCUUGUACUGCUGAAGUGCUGUACAGU

```{r SECIS, fig.show="hold", fig.cap="Caption", echo=FALSE, out.width='33%', fig.show='hold', fig.align='center', out.height=300}
knitr::include_graphics("SECIS_RELIABLE.svg")
knitr::include_graphics("SECIS_ATLAS.svg")
knitr::include_graphics("SECIS_KT.svg")

```

RNase P Junction (3P22)
GGCAGUGCUCAGUAACAGUGCC

```{r RNaseP, fig.show="hold", fig.cap="Caption", echo=FALSE, out.width='50%', fig.show='hold', fig.align='center', out.height=300}
knitr::include_graphics("RNAP_RELIABLE.svg")
knitr::include_graphics("RNAP_ATLAS.svg")

```

Sarcin-Ricin Loop (3S8U)
...
knitr::include_graphics("SRL_RELIABLE.svg")
knitr::include_graphics("SRL_ATLAS.svg")
